            ...
            if(!textAltura.text.isEmpty() && !textQuilos.text.isEmpty() && !textIdade.text.isEmpty()) {
                ...
                if(click == 1) {
                    ...
                    if(idade < 18) {
                        ...
                        if(calculaIMC < 19) {
                            textIMC.setText("Seu IMC é " + calculaIMC + " (Peso baixo)");
                        } else if(calculaIMC >= 19 && calculaIMC <= 24.9) {
                            textIMC.setText("Seu IMC é " + calculaIMC + " (Peso normal)");
                        } else if(calculaIMC >= 25 && calculaIMC <= 29.9) {
                            textIMC.setText("Seu IMC é " + calculaIMC + " (Pré obesidade)");
                        } else if(calculaIMC >= 30 && calculaIMC <= 39.9) {
                            textIMC.setText("Seu IMC é " + calculaIMC + " (Obesidade)");
                        } else if(calculaIMC > 39.9) {
                            textIMC.setText("Seu IMC é " + calculaIMC + " (Obesidade grave)");
                        }
